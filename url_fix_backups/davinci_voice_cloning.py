...
#             }
    ...
    def _create_demo_audio(self, output_path: str, text: str):
        ...
        try:
            ...
            subprocess.run(["say", "-o", output_path.replace(".mp3", ".aiff"), text], check=True)
...
#         ]
        ...
        for demo in demo_samples:
            ...
            try:
                subprocess.run(["say", "-o", str(sample_path), demo["text"]], check=True)
...
#         )
    ...
    async def batch_clone_voices(
        ...
        tasks = [self.clone_voice(text, voice_sample_name, engine_name) for text in texts]
