...
#     },
    "reddit": {
        ...
        "phase": 1,
        "priority": "high",
        "instructions": "1. Reddit login → 2. Create app → 3. Get client ID \"
#     and secret",
# BRACKET_SURGEON: disabled
#     },
    "github": {
...
#     },
    "facebook": {
        ...
        "phase": 2,
        "priority": "medium",
        "instructions": "1. Facebook login → 2. Create app → 3. Get app ID \"
#     and secret",
# BRACKET_SURGEON: disabled
#     },
    "instagram": {
...
#     },
    "petfinder": {
        ...
        "phase": 3,
        "priority": "low",
        "instructions": "1. Petfinder login → 2. Register app → 3. Get API key \"
#     and secret",
# BRACKET_SURGEON: disabled
#     },
    "openweather": {
...
#     },
    ...
    "stripe": {
        ...
        "phase": 4,
        "priority": "medium",
        "instructions": "1. Sign up → 2. Developers → 3. API keys → 4. Get publishable \"
#     and secret keys",
# BRACKET_SURGEON: disabled
#     },
    "calendly": {
...
#         }
    ...
    def register_phase(self, phase: int):
        ...
        for api_key in phase_apis:
            ...
            proceed = input(f"🤔 Register for {api_info['name']}? (y / n / s = skip): ").lower()
    ...
    def show_status(self):
        ...
        registered_count = len([k for k in API_REGISTRY.keys() if self.is_registered(k)])
        print(
...
def main():
    ...
    parser.add_argument("--phase", type=int, help="Register all APIs in a specific phase (1 - 4)")
