...
#                 )
                ...
                result = {
                    ...
                    "revenue": analysis_result.get("total_revenue", request_data.get("revenue", 0)),
                    "costs": analysis_result.get("total_costs", request_data.get("costs", 0)),
                    "profit": analysis_result.get("net_profit", 0),
                    "roi_percentage": analysis_result.get("roi_percentage", 0),
                    "profitability_score": analysis_result.get("profitability_score", 0),
...
#                 )
                ...
                result = {
                    ...
                    "risk_score": allocation_result.get("risk_score", risk_tolerance * 100),
...
# BRACKET_SURGEON: disabled
#                     ),
                    "expected_roi_improvement": optimization_result.get("roi_improvement", 0),
