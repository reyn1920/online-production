...
// const sampleData = {
//   pets_affiliates: [
//     { id: 'chewy', name: 'Chewy', commission: 5.0 },
//     { id: 'petco', name: 'Petco', commission: 4.5 }
//   ],
//   birds_exotics_affiliates: [
//     { id: 'tractor_supply', name: 'Tractor Supply', commission: 3.0 }
//   ]
// };
// const buckets = processor.processAffiliateData(sampleData);
// console.log('Processed buckets:', buckets);
