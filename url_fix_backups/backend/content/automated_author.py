...
#                     )
            ...
            checkpoint_file = (
                self.checkpoint_dir / f"{project_id}_{timestamp_str}_{content_hash}.checkpoint"
# FIXIT: commented possible stray closer
# FIXIT: commented possible stray closer
#             )
...
#                     )
            ...
            self.logger.info(
                f"Recovery info - Chapters: {recovery_info.get('completed_chapters',"
    0)}/{recovery_info.get('total_chapters',
# BRACKET_SURGEON: disabled
#     0)},
    Stage: {recovery_info.get('current_stage', 'unknown')}""
# FIXIT: commented possible stray closer
# FIXIT: commented possible stray closer
#             )
