...
class AIIntelligentRouter:
    ...
    def _estimate_cost(self, server_id: str, request_analysis: Dict) -> float:
        ...
        complexity_multiplier = {
            ...
            'medium': 1.5,
            'high': 2.5
        }.get(request_analysis.get('complexity', 'medium'), 1.5)
        ...
        def get_router_status():
            ...
            try:
                status = {
                    ...
                    'active_connections': sum(m.active_connections for m in self.server_metrics.values()),
                    'total_requests': len(self.routing_history),
    ...
    v in self.server_metrics.items()},
        ...
        def route_request_endpoint():
            ...
            try:
                ...
                if not request_data:
                    return jsonify({'success': False, 'error': 'No request data provided'}),
    400
