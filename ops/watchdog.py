    ...
    while True:
        try:
            ...
            if not is_running("monitoring_system"):
                ...
                if svc.get("critical", False) or svc.get("restart_policy", {}).get("mode") == "always":
                    ...
                    logger.info("ℹ️ Service monitoring_system marked non-critical, restart skipped (config).")
