...
class TestDatabaseIntegrity:
    ...
    def test_database_connection(self, system_test):
        ...
        assert (
            system_test.db_path.exists()
        ), f"Database file not found: {system_test.db_path}"
...
class TestCoreToolVerification:
    ...
    def test_davinci_resolve_api(self):
        ...
        try:
            ...
            pytest.skip(
                "DaVinci Resolve API not available (acceptable for testing environment)"
            )
    ...
    def test_initialize_core_agents(self):
        ...
        try:
            ...
            for agent_class, agent_name in agent_classes:
                ...
                ), f"{agent_name} missing __init__ method"
                assert hasattr(
