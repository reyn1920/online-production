...
class CorrectEvolutionAgent:
    ...
    def __init__(self, agent_id: str = "evolution_agent", name: str = "Evolution Agent", config: dict = None):
...
if __name__ == "__main__":
    ...
    try:
        ...
        print(f"Capabilities: {problematic_agent.capabilities}")  # This will cause RecursionError
