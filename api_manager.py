    ...
    def discover_channel_apis(
        ...
        try:
            ...
            if result.get("success"):
                self.logger.info(
                    f"✅ Successfully discovered {result.get('apis_integrated', 0)} APIs for {channel}"
                )
            ...
            try:
                ...
                if command == "quit" or command == "exit":
                    ...
                    if "error" not in stats:
                        ...
                        print(
                            f"   • Free APIs: {stats.get('by_status', {}).get('free', 0)}"
                        )
                        print(
                            f"   • Freemium APIs: {stats.get('by_status', {}).get('freemium', 0)}"
                        )
                        print(
                            f"   • Paid APIs: {stats.get('by_status', {}).get('paid', 0)}"
                        )
                        print(
                    ...
                    if "error" not in costs:
                        print(f"\n💰 Cost Analysis:")
                        print(
                            f"   • Monthly Cost: ${costs.get('total_monthly_cost', 0):.2f}"
                        )
                        print(
