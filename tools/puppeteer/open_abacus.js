// path: tools/puppeteer/open_abacus.js
...
(async () => {
  ...
  await page.goto("https://apps.abacus.ai/chatllm/?appId=1024a18ebe");
  console.log("[PUP] Abacus AI opened with your browser profile.");
})().catch(err => {
