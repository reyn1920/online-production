...
#         )
    ...
    def test_create_subscription_checkout(self, mock_stripe):
        ...
        mock_stripe.return_value = Mock(id="cs_test_123", url="https://checkout.stripe.com/test")
...
#         )
        ...
        self.assertIn(fraud_check.risk_level, [FraudRiskLevel.HIGH, FraudRiskLevel.BLOCKED])
    ...
    def test_process_stripe_payment(self, mock_stripe):
        ...
        mock_intent.client_secret = os.getenv("TEST_CLIENT_SECRET", "pi_test_123_secret")
