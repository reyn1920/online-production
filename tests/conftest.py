...
TEST_CONFIG = {
    ...
    'enable_real_services': os.getenv('TEST_ENABLE_REAL_SERVICES', 'false').lower() == 'true',
...
for directory in [TEST_CONFIG['test_output_dir'], TEST_CONFIG['test_data_dir'], TEST_CONFIG['test_artifacts_dir']]:
...
def sample_test_data():
    ...
    return {
        ...
        "test_agent_status": {"agent_id": "test-agent", "status": "running", "health": "good"}
    }
