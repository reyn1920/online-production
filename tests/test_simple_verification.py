    ...
    def test_dashboard_connectivity(self):
        ...
        try:
            ...
            if response.status_code == 200:
                ...
                self.log_result(
                    "Dashboard Connectivity", False, f"HTTP {response.status_code}"
                )
                return False
        except Exception as e:
            self.log_result(
                "Dashboard Connectivity", False, f"Connection error: {str(e)}"
            )
            return False
    ...
    def test_agents_endpoint(self):
        ...
        try:
            ...
            if response.status_code == 200:
                ...
                self.log_result(
                    "Agents Endpoint", False, f"HTTP {response.status_code}"
                )
                return False
        except Exception as e:
