...
def generate_interior_design(specs: Dict[str, Any]) -> Dict[str, Any]:
    ...
    response = openai.ChatCompletion.create(
        ...
        messages=[
            {
                "role": "system",
                "content": "You are a professional interior designer with expertise in various styles and budgets.",
            },
            {"role": "user", "content": prompt},
        ],
        max_tokens=1500,
...
def generate_brand_identity(specs: Dict[str, Any]) -> Dict[str, Any]:
    ...
    response = openai.ChatCompletion.create(
        ...
        messages=[
            {
                "role": "system",
                "content": "You are a brand strategist and designer who creates cohesive brand identities.",
            },
            {"role": "user", "content": prompt},
        ],
        max_tokens=2000,
