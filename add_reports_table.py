    ...
    try:
        ...
        for report in sample_reports:
            cursor.execute("""
                ...
                VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?)
            """, (
                report['report_type'], report['title'], report['content'], report['key_headline'],
                report['date_range_start'], report['date_range_end'], report['generated_by'],
                report['generation_parameters'], report['file_size_bytes'], report['tags']
            ))
