...
from backend.content.universal_channel_protocol import get_protocol, ChannelType, ContentFirewallLevel
...
def integrate_all_channels():
    ...
    for channel_name, channel_data in config['channels'].items():
        try:
            ...
            firewall_level = ContentFirewallLevel.STRICT if channel_data.get('category') == 'politics' else ContentFirewallLevel.STANDARD
