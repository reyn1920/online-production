    ...
    async def run_concurrent_test(
        ...
        async with httpx.AsyncClient(limits=limits, timeout=timeout, verify=False) as client:
            ...
            while time.perf_counter() < end_time:
                # Maintain concurrent_users active requests
    ...
    def analyze_results(self, results: List[Dict], duration: float) -> Dict[str, Any]:
        ...
        stats = {
            ...
            "latency_ms": {
                ...
                "p95": round(statistics.quantiles(durations, n=20)[18] * 1000, 2) if len(durations) > 20 else 0,
                "p99": round(statistics.quantiles(durations, n=100)[98] * 1000, 2) if len(durations) > 100 else 0,
            },
