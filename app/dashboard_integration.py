...
class DashboardIntegration:
    ...
    def _capture_performance_snapshot(self):
        ...
        snapshot = {
            ...
            'success_rate': (
                self.system_metrics.total_successes / max(self.system_metrics.total_executions, 1)
            ) * 100,
    ...
    def get_dashboard_data(self) -> Dict[str, Any]:
        ...
        with self.metrics_lock:
            return {
                ...
                'system_metrics': asdict(self.system_metrics),
                'action_metrics': {
                    name: asdict(metrics) for name, metrics in self.action_metrics.items()
                },
                ...
                'quick_stats': {
                    ...
                    ) / len(self.action_metrics) if self.action_metrics else 0,
