...
class IntegrationMonitor:
    ...
    def _get_test_url(self, provider: Provider) -> Optional[str]:
        ...
        test_urls = {
            "nominatim_osm": f"{provider.base_url}/search?q=London&format=json&limit=1",
    ...
    async def check_specific_providers(self, provider_ids: List[str]) -> Dict[str, Dict[str, Any]]:
