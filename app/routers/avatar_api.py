...
async def process_uploaded_image(request: ImageProcessRequest):
    ...
    try:
        ...
        processed_result = background_remover.remove_background(
            image,
            enhance_transparency=request.enhance
        )
...
async def get_available_styles():
    ...
    return JSONResponse({
        "styles": [
            {"id": "geometric", "name": "Geometric", "description": "Clean geometric shapes with golden ratio proportions"},
            {"id": "organic", "name": "Organic", "description": "Natural, flowing forms inspired by nature"},
            {"id": "professional", "name": "Professional", "description": "Clean, business-appropriate designs"},
            {"id": "artistic", "name": "Artistic", "description": "Creative and expressive designs"},
            {"id": "minimal", "name": "Minimal", "description": "Simple, clean designs with maximum impact"},
            {"id": "golden_ratio", "name": "Golden Ratio", "description": "Pure mathematical beauty based on golden ratio"}
        ],
        "color_schemes": [
            ...
            {"id": "warm", "name": "Warm", "description": "Warm colors like reds, oranges, yellows"},
            {"id": "cool", "name": "Cool", "description": "Cool colors like blues, greens, purples"},
