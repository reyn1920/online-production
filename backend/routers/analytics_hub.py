        ...
        if client.ready():
            ...
            try:
                ...
                if insights.get('ok', True):  # Assume success if 'ok' not present
                    ...
                    engagement = insights.get('engagement', insights.get('saves', insights.get('karma', 0)))
...
async def get_platform_analytics(platform: str):
    ...
    try:
        ...
        if platform == "instagram":
            ...
            insights['engagement_rate'] = round((insights.get('engagement', 0) / max(insights.get('followers', 1), 1)) * 100, 2)
            ...
            insights['monthly_views'] = insights.get('monthly_views', insights.get('impressions', 0))
            ...
            try:
                ...
                if insights.get('ok', True):
                    comparison[platform] = {
                        ...
                        "impressions": insights.get('impressions', 0),
                        "engagement": insights.get('engagement', insights.get('saves', insights.get('karma', 0))),
                        "engagement_rate": round((insights.get('engagement', 0) / max(insights.get('followers', 1), 1)) * 100, 2),
                        "status": "active"
                    }
                else:
                    comparison[platform] = {"status": "error", "error": insights.get('error', 'Unknown error')}
            except Exception as e:
