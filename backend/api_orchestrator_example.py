...
from api_orchestrator import APIOrchestrator, FailoverStrategy, APIRequest
...
class ExampleService:
    ...
    async def make_llm_request(self, prompt: str, model: str = "gpt-3.5-turbo") -> Dict[str, Any]:
...
async def main():
    ...
    try:
        ...
        search_response = await service.make_search_request("API orchestration best practices")
