...
class MetricsCollector:
    ...
    def collect_system_metrics(self):
        ...
        try:
            ...
            self.metrics['system_network_io'].labels(direction='sent')._value._value = network.bytes_sent
            self.metrics['system_network_io'].labels(direction='recv')._value._value = network.bytes_recv
...
class ZeroCostMonitoringStack:
    ...
    def _generate_dashboards(self):
        ...
        try:
            ...
            self.dashboard_generator.save_dashboard(
                app_dashboard, 
                "grafana_application_dashboard.json"
            )
