...
from alert_manager import alert_manager, AlertSeverity, AlertCategory
from health_monitor import health_monitor, HealthStatus
from compliance_monitor import compliance_monitor
from audit_logger import audit_logger
from monitoring_dashboard import dashboard, start_dashboard, stop_dashboard
...
class MonitoringOrchestrator:
    ...
    def __init__(self, config_path: Optional[str] = None):
        self.config_path = config_path or os.path.join(os.path.dirname(__file__), 'monitoring_config.yaml')
...
def start_monitoring_system(config_path: Optional[str] = None) -> MonitoringOrchestrator:
