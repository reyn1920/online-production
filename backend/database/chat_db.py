...
"""
    ...
    def create_conversation(self, user_id: str = "anonymous", title: Optional[str] = None) -> str:
        """
...
""""""
    ...
    def search_messages(self, query: str, user_id: Optional[str] = None, limit: int = 50) -> List[Dict[str, Any]]:
        """
...
def create_conversation(user_id: str = "anonymous", title: Optional[str] = None) -> str:
    """
...
"""
    ...
    """"""
def search_chat(query: str, user_id: Optional[str] = None, limit: int = 50) -> List[Dict[str, Any]]:
    """Search messages by content"""
    return chat_db.search_messages(query, user_id, limit)