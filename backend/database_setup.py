    ...
    try:
        ...
        with sqlite3.connect(db_path) as conn:
            ...
            if cursor.fetchone():
                ...
                common_columns = []
                target_columns = ['title', 'content', 'url', 'source', 'published_date', 
                                'category', 'sentiment', 'relevance_score', 'keywords', 
                                'summary', 'task_name', 'created_at', 'updated_at']
                ...
                if common_columns:
                    ...
                    logger.info(f"Migrated {migrated_count} records from news_articles to news_intelligence")
