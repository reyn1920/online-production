...
class CostTrackingService:
    ...
    def track_api_usage(
        self, api_name: str, requests_count: int = 1, cost: float = 0.0
    ):
            ...
            with sqlite3.connect(self.db_path) as conn:
                ...
                return {
                    "total_monthly_cost": total_cost,
                        ...
                        100, (total_cost / self.monthly_budget) * 100
                    ),
    ...
    def set_budget_alert(
        self, api_name: str, threshold_type: str, threshold_value: float
    ):
    ...
    def export_cost_report(self) -> Dict[str, Any]:
        ...
        try:
            ...
            with sqlite3.connect(self.db_path) as conn:
                ...
                daily_costs = [
                    {"date": row[0], "cost": row[1]} for row in cursor.fetchall()
                ]
...
if __name__ == "__main__":
    ...
    if args.action == "track" and args.api_name:
        ...
        print(
            f"Tracked usage for {args.api_name}: {args.requests} requests, ${args.cost}"
        )
        ...
        args.action == "alert"
        and args.api_name
        and args.threshold_type
        and args.threshold_value
    ):
        service.set_budget_alert(
            args.api_name, args.threshold_type, args.threshold_value
        )
