            ...
            if os.getenv('TWITTER_INTEGRATION_ENABLED', 'true').lower() == 'true':
                ...
                if twitter_integration.test_connection():
                    ...
                    if os.getenv('TWITTER_ENGAGEMENT_ENABLED', 'true').lower() == 'true':
                        from backend.agents.twitter_engagement_agent import TwitterEngagementAgent
                    ...
                    if os.getenv('TWITTER_PROMOTION_ENABLED', 'true').lower() == 'true':
                        from backend.agents.twitter_promotion_agent import TwitterPromotionAgent
                    ...
                    logger.warning("⚠️ Twitter Integration connection failed - agents not initialized")
