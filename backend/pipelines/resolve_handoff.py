...
def get_resolve_path() -> str:
    ...
    return get_setting("resolve_path", "/Applications/DaVinci Resolve/DaVinci Resolve.app/Contents/MacOS/Resolve")
...
def validate_resolve_installation() -> Dict[str, Any]:
    ...
    try:
        ...
        if app_bundle.name.endswith(".app"):
            ...
            return {
                "ok": False,
                "error": "Invalid Resolve application structure"
            }
    
    except Exception as e:
        return {
            "ok": False,
            "error": f"Error checking Resolve: {str(e)}"
        }
...
def create_resolve_timeline(project_path: str, timeline_name: str, clips: List[Dict[str, Any]]) -> Dict[str, Any]:
...
def export_resolve_timeline(project_path: str, timeline_name: str, export_settings: Dict[str, Any]) -> Dict[str, Any]:
...
def get_resolve_project_info(project_path: str) -> Dict[str, Any]:
    ...
    try:
        ...
        return {
            "ok": False,
            "error": f"Error reading project info: {str(e)}"
        }