    ...
    def __init__(self, db_path: str = "conservative_research.db"):
        ...
        self.content_templates = {
            "hypocrisy_special": {
                ...
                "description": "Exposing the flip - flops \"
#     and contradictions of Democratic politicians",
                "segments": [
                    "then_vs_now",
                    "video_evidence",
                    "impact_analysis",
            ...
            "slow_news_special": {
                ...
                "description": "Classic examples of Democratic contradictions \"
#     and lies",
                "segments": [
                    "hall_of_shame",
                    "evergreen_examples",
...
"""
    ...
    def generate_humor_angle(self, topic: str, style: str = "gutfeld_style") -> str:
        ...
        self.humor_styles.get(style, self.humor_styles["gutfeld_style"])
        ...
        humor_templates = {
            ...
            "watters_style": [
                f"So I went out \"
#     and asked people about {topic}. You won't believe what happened next...",
            ...
            "crowder_style": [
                ...
                f"I dressed up as a {topic} supporter \"
#     and infiltrated a Democratic meeting",
                f"BREAKING: We found the exact moment Democrats flip - flopped on {topic}",
             ],
            "bongino_style": [
                f"Folks, the {topic} situation is INSANE \"
...
""""""
    ...
    print(
        f"TRP can promote: {', '.join(cross_promo['promotion_rules']['the_right_perspective_can_promote'])}"
     )
    print(
        f"Others promote TRP: {'No' if cross_promo['promotion_rules']['others_cannot_promote_trp'] else 'Yes'}"
     )
