...
try:
    from .universal_channel_protocol import get_protocol, ChannelType
except ImportError:
...
class ChannelPersonas:
        ...
        return {
            ChannelType.TECH: {
                "base_persona": {
                    ...
                    "tone_attributes": ["informative", "analytical", "forward-thinking", "precise"],
                    "expertise_areas": ["technology", "innovation", "software development", "digital trends"],
                    ...
                    "preferred_formats": ["tutorials", "analysis", "reviews", "predictions"]
                },
            ...
            ChannelType.WELLNESS: {
                "base_persona": {
                    ...
                    "expertise_areas": ["health", "nutrition", "mental wellness", "fitness"],
                    ...
                    "preferred_formats": ["guides", "tips", "personal stories", "research summaries"]
                },
                "voice_characteristics": {
            ...
            ChannelType.FINANCE: {
                "base_persona": {
                    ...
                    "vocabulary_level": VocabularyLevel.ADVANCED,
                    "tone_attributes": ["analytical", "data-driven", "strategic", "cautious"],
                    "expertise_areas": ["investing", "market analysis", "financial planning", "economics"],
                    ...
                    "preferred_formats": ["market analysis", "investment guides", "economic commentary"]
                },
                "voice_characteristics": {
            ...
            ChannelType.POLITICAL: {
                "base_persona": {
                    ...
                    "vocabulary_level": VocabularyLevel.INTERMEDIATE,
                    "tone_attributes": ["sarcastic", "witty", "provocative", "authoritative"],
                    "expertise_areas": ["politics", "current events", "conservative ideology", "media criticism"],
                    ...
                    "preferred_formats": ["commentary", "analysis", "satire", "fact-checking"]
                },
                "voice_characteristics": {
            ...
            ChannelType.BUSINESS: {
                "base_persona": {
                    "writing_style": WritingStyle.PROFESSIONAL,
                    "vocabulary_level": VocabularyLevel.ADVANCED,
                    "tone_attributes": ["strategic", "results-oriented", "pragmatic", "leadership-focused"],
                    "expertise_areas": ["entrepreneurship", "management", "strategy", "growth"],
                    ...
                    "preferred_formats": ["case studies", "strategy guides", "leadership insights"]
                },
                "voice_characteristics": {
            ...
            ChannelType.SCIENCE: {
                "base_persona": {
                    ...
                    "tone_attributes": ["curious", "methodical", "evidence-based", "wonder-filled"],
                    "expertise_areas": ["research", "discovery", "scientific method", "innovation"],
                    ...
                    "preferred_formats": ["research summaries", "discovery stories", "explanations"]
                },
                "voice_characteristics": {
    ...
    def _initialize_tone_modifiers(self) -> Dict[str, Dict[str, Any]]:
        ...
        return {
            "sarcastic": {
                "sentence_starters": ["Oh, how surprising...", "Let me guess...", "Shocking news:"],
                "transitions": ["But here's the kicker", "Plot twist", "Surprise, surprise"],
                "emphasis_words": ["obviously", "clearly", "naturally", "of course"]
            },
            "witty": {
                "sentence_starters": ["Here's a thought:", "Picture this:", "Fun fact:"],
                "transitions": ["Speaking of which", "On a related note", "While we're at it"],
                "emphasis_words": ["cleverly", "brilliantly", "ingeniously"]
            },
            "authoritative": {
                "sentence_starters": ["The fact is", "Research shows", "Evidence indicates"],
                "transitions": ["Furthermore", "Additionally", "Moreover"],
                "emphasis_words": ["definitively", "conclusively", "undeniably"]
            },
            "caring": {
                "sentence_starters": ["I understand that", "Many of us feel", "It's important to remember"],
                "transitions": ["With that in mind", "Taking this into account", "Considering this"],
                "emphasis_words": ["gently", "compassionately", "thoughtfully"]
            },
            "analytical": {
                "sentence_starters": ["The data suggests", "Analysis reveals", "Breaking this down"],
                "transitions": ["Examining further", "Digging deeper", "Looking at the metrics"],
    ...
    def create_persona(self, channel_id: str, custom_config: Dict[str, Any] = None) -> PersonaProfile:
        ...
        persona = PersonaProfile(
            ...
            writing_style=WritingStyle(persona_config.get("writing_style", WritingStyle.PROFESSIONAL)),
            vocabulary_level=VocabularyLevel(persona_config.get("vocabulary_level", VocabularyLevel.INTERMEDIATE)),
    ...
    def _save_persona(self, persona: PersonaProfile):
        ...
        with sqlite3.connect(self.db_path) as conn:
            ...
            cursor.execute("""
                ...
                VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)
            """, (
                persona.persona_id, persona.channel_id, persona.persona_name,
                persona.writing_style.value, json.dumps(persona.tone_attributes),
                persona.vocabulary_level.value, persona.humor_style,
                json.dumps(persona.expertise_areas), persona.target_audience,
    ...
    def adapt_content_to_persona(self, channel_id: str, content: str, content_type: str = "script") -> str:
    ...
    def _add_persona_elements(self, content: str, persona: PersonaProfile, content_type: str) -> str:
        ...
        if persona.expertise_areas:
            expertise_markers = {
                "technology": ["As someone who's been in tech for years", "From a technical standpoint"],
        ...
        for sentence in sentences:
            ...
            # If too long, consider breaking
                ...
                for i, word in enumerate(words):
                    if word.lower() in ['however', 'therefore', 'furthermore', 'moreover'] and i > 8:
                        first_part = ' '.join(words[:i])
