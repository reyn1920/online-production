...
class HumorStyleDatabase:
    ...
    def __init__(self, db_path: str = "./data/right_perspective.db"):
        ...
        self.logger.info(
            "Humor Style Database initialized for The Right Perspective (PROTECTED)"
        )
    ...
    def _generate_content_hooks(
        self, topic: str, evidence_data: Dict[str, Any]
    ) -> List[str]:
        ...
        if evidence_data.get("content_type") == "quote":
            ...
            hooks.append(
                f"The numbers on {topic} are in, and they're not what politicians claimed."
            )
