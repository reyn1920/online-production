...
class WebhookSecurityManager:
    ...
    async def validate_incoming_webhook(self, 
                                      webhook_id: str,
                                      payload: str,
                                      signature: Optional[str],
                                      source_ip: str,
        ...
        try:
            ...
            # Check IP allowlist
            if webhook_config.security_level in [WebhookSecurityLevel.ENHANCED, WebhookSecurityLevel.MAXIMUM]:
            ...
            # Check signature
            if webhook_config.security_level in [WebhookSecurityLevel.STANDARD, WebhookSecurityLevel.ENHANCED, WebhookSecurityLevel.MAXIMUM]:
                if not signature:
                    ...
                    audit_logger.log_security_event(
                        ...
                        ip_address=source_ip,
                        additional_data={'webhook_id': webhook_id, 'signature': signature}
                    )
                else:
    ...
    async def send_webhook(self, 
                          ...
                          event_type: WebhookEventType,
                          payload: Dict[str, Any],
                          custom_headers: Optional[Dict[str, str]] = None) -> WebhookDeliveryResult:
        ...
        signature = self.generate_signature(
            ...
            webhook_config.signature_algorithm
        )
    ...
    def get_webhook_security_report(self) -> Dict[str, Any]:
        ...
        https_compliant = sum(
            1 for wh in self.webhooks.values() 
            if urlparse(wh.url).scheme == 'https'
        )
        ...
        report = {
            ...
            'security_compliance': {
                ...
                'signature_verification_enabled': all(
                    wh.security_level != WebhookSecurityLevel.BASIC
