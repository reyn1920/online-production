...
class WebhookSecurityManager:
    ...
    def _get_or_create_encryption_key(self) -> bytes:
        ...
        # Generate new key
        password = os.getenv(
            "WEBHOOK_MASTER_PASSWORD", "default_webhook_password"
        ).encode()
        salt = os.urandom(16)
        kdf = PBKDF2HMAC(
    ...
    def _load_webhook_configs(self):
        ...
        default_webhook = WebhookConfig(
            ...
            url=os.getenv(
                "CHATGPT_WEBHOOK_URL", "https://api.example.com/webhooks/chatgpt"
            ),
    ...
    def register_webhook(self, webhook_config: WebhookConfig) -> bool:
        ...
        try:
            ...
            if not validation_result["valid"]:
                self.logger.error(
                    f"Invalid webhook config: {validation_result['errors']}"
                )
                return False
    ...
    def generate_signature(
        self, payload: str, secret_key: str, algorithm: str = "sha256"
    ) -> str:
    ...
    async def validate_incoming_webhook(
        ...
        try:
            ...
            if webhook_config.security_level in [
                ...
                elif not self.verify_signature(
                    payload, signature, webhook_config.secret_key
                ):
    ...
    def get_webhook_security_report(self) -> Dict[str, Any]:
        ...
        recent_deliveries = [
            ...
            if datetime.fromisoformat(delivery.timestamp)
