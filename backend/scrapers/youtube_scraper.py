...
class YouTubeScraperForRightPerspective:
    def __init__(self, db_path: str = "conservative_research.db"):
        ...
        self.conservative_channels = {
            'greg_gutfeld': {
                ...
                'content_focus': ['political humor', 'liberal hypocrisy', 'cultural commentary']
            },
            'jesse_watters': {
                ...
                'content_focus': ['political analysis', 'media criticism', 'cultural issues']
            },
            'dan_bongino': {
            ...
            'steven_crowder': {
                ...
                'content_focus': ['campus activism', 'liberal policies', 'cultural debates']
            },
            'ben_shapiro': {
                ...
                'content_focus': ['political analysis', 'media bias', 'cultural issues']
            },
            'charlie_kirk': {
                ...
                'content_focus': ['campus politics', 'conservative activism', 'youth engagement']
            },
            'tucker_carlson': {
                'channel_id': 'UCwWhs_6x42TyRM4Wstoq8HA',
                'channel_name': 'Tucker Carlson Network',
                'style_notes': 'Investigative journalism, long-form interviews, serious tone',
                'content_focus': ['deep investigations', 'establishment criticism', 'foreign policy']
            },
            'the_right_perspective_existing': {
                ...
                'content_focus': ['gaming politics', 'conservative commentary', 'cultural criticism']
            }
        }
        ...
        self.content_keywords = {
            'hypocrisy_indicators': [
                'flip flop', 'changed position', 'contradicts', 'hypocrite',
                'said before', 'used to support', 'now opposes'
            ],
            'humor_styles': [
                'satire', 'parody', 'comedy', 'joke', 'funny', 'hilarious',
                'mocking', 'ridiculous', 'absurd', 'clown world'
            ],
            'political_targets': [
                'biden', 'harris', 'pelosi', 'schumer', 'aoc', 'democrat',
                'liberal', 'progressive', 'mainstream media', 'fake news'
            ],
            'conservative_themes': [
                'america first', 'traditional values', 'constitution',
                'freedom', 'liberty', 'patriot', 'maga', 'trump'
            ]
        }
    ...
    def analyze_content_style(self, title: str, description: str, channel_name: str) -> Dict:
    ...
    def scrape_channel_videos(self, channel_config: Dict, max_videos: int = 50) -> List[Dict]:
        ...
        for video_data in sample_videos[:max_videos]:
            try:
                ...
                video_info = {
                    ...
                    'right_perspective_potential': style_analysis['relevance_score'] >= 3.0
                }
    ...
    def scrape_all_channels(self) -> Dict[str, int]:
        ...
        for channel_key, channel_config in self.conservative_channels.items():
            ...
            logger.info(f"Scraped {saved} videos from {channel_config['channel_name']} ({high_potential} high-potential)")
...
def main():
    ...
    for i, video in enumerate(inspiration, 1):
        ...
        print(f"   Humor Score: {video['humor_score']}, Relevance: {video['relevance_score']}")
