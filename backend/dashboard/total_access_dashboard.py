...
class TotalAccessDashboard:
    ...
    def setup_websocket_handlers(self):
        ...
        def handle_subscribe(data):
            ...
            self.logger.info(
                f"Client {request.sid} subscribed to {update_type} updates"
            )
    ...
    def start_metrics_thread(self):
        ...
        self.metrics_thread = threading.Thread(
            target=self.metrics_collection_loop, daemon=True
        )
        ...
        try:
            ...
            if self.task_queue:
                ...
                active_agents = sum(
                    ...
                    if status["status"] in ["active", "busy"]
                )
    ...
    def get_performance_analytics(self, days: int = 7) -> Dict[str, Any]:
        ...
        try:
            ...
            with sqlite3.connect(self.db_path) as conn:
                ...
                health_trends = [
                    {"date": row[0], "cpu_usage": row[1]} for row in cursor.fetchall()
                ]
...
<body class="bg-gray-100">
    <div class="container mx-auto px-4 py-8">
        <header class="mb-8">
            ...
            <p class="text-gray-600">Real-time system monitoring and explainable AI telemetry</p>
        </header>
