...
class RSSFeedManager:
        ...
        if not self._feeds_loaded:
            with self._lock:
                if not self._feeds_loaded:
                    ...
                    self.logger.info(f"RSS Feed Manager: Loaded {len(self._feeds_cache)} RSS feeds (singleton)")
    ...
    def _get_default_feeds(self) -> List[Dict[str, str]]:
        ...
        return [
            ...
            {'url': 'https://rss.cnn.com/rss/edition.rss', 'category': 'general', 'name': 'CNN'},
            {'url': 'https://feeds.bbci.co.uk/news/rss.xml', 'category': 'general', 'name': 'BBC News'},
            {'url': 'https://www.reddit.com/r/technology/.rss', 'category': 'technology', 'name': 'Reddit Technology'},
            {'url': 'https://www.wired.com/feed/rss', 'category': 'technology', 'name': 'Wired'},
            {'url': 'https://feeds.feedburner.com/venturebeat/SZYF', 'category': 'business', 'name': 'VentureBeat'},
            {'url': 'https://feeds.feedburner.com/Mashable', 'category': 'technology', 'name': 'Mashable'},
            {'url': 'https://www.theverge.com/rss/index.xml', 'category': 'technology', 'name': 'The Verge'},
            {'url': 'https://feeds.feedburner.com/oreilly/radar', 'category': 'technology', 'name': "O'Reilly Radar"},
            {'url': 'https://feeds.feedburner.com/fastcompany/headlines', 'category': 'business', 'name': 'Fast Company'},
            {'url': 'https://feeds.feedburner.com/entrepreneur/latest', 'category': 'business', 'name': 'Entrepreneur'},
            {'url': 'https://feeds.feedburner.com/socialmediaexaminer', 'category': 'marketing', 'name': 'Social Media Examiner'},
            {'url': 'https://feeds.feedburner.com/copyblogger', 'category': 'marketing', 'name': 'Copyblogger'},
            {'url': 'https://feeds.feedburner.com/MarketingLand', 'category': 'marketing', 'name': 'Marketing Land'},
            {'url': 'https://feeds.feedburner.com/searchengineland', 'category': 'marketing', 'name': 'Search Engine Land'},
            {'url': 'https://feeds.feedburner.com/hubspot', 'category': 'marketing', 'name': 'HubSpot Blog'},
            {'url': 'https://feeds.feedburner.com/bufferapp', 'category': 'social_media', 'name': 'Buffer Blog'},
            {'url': 'https://feeds.feedburner.com/hootsuite', 'category': 'social_media', 'name': 'Hootsuite Blog'}
        ]
