...
class ChannelAvatarManager:
    ...
    def __init__(self, db_path: str = None):
        self.db_path = db_path or "/Users/thomasbrianreynolds/online production/right_perspective.db"
    ...
    def get_channel_avatar(self, channel_id: int) -> Optional[Dict]:
        ...
        try:
            with self._get_db_connection() as conn:
                ...
                self.logger.info(f"No avatar found for channel {channel_id}, generating golden ratio avatar")
    ...
    def _create_avatar_config_from_name(self, channel_name: str) -> Dict:
        ...
        color_schemes = ['monochrome', 'complementary', 'triadic', 'warm', 'cool', 'vibrant']
    ...
    def _save_avatar_to_db(self, channel_id: int, avatar_data: Dict, 
                          is_default: bool = False, generation_method: str = 'manual') -> int:
    ...
    def upload_custom_avatar(self, channel_id: int, image_data: str, 
        ...
        try:
            ...
            image_bytes = base64.b64decode(
                processing_result['processed_image'].split(',')[1]
            )
    ...
    def regenerate_avatar(self, channel_id: int, style: str = None, 
                         color_scheme: str = None) -> Dict:
