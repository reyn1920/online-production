...
class BackgroundRemover:
    ...
    def _fallback_background_removal(self, image_data: Union[bytes, str, Image.Image]) -> Image.Image:
        ...
        try:
            ...
            return image if isinstance(image_data, Image.Image) else Image.open(io.BytesIO(image_data))
    ...
    def process_avatar_upload(self, image_data: Union[bytes, str, Image.Image], 
                            enhance: bool = True) -> Tuple[Image.Image, str]:
