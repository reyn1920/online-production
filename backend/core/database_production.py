...
class ProductionDatabaseManager:
    ...
    def __init__(self, database_url: Optional[str] = None):
        self.database_url = database_url or os.getenv('DATABASE_URL', 'sqlite:///data/trae_master.db')
    ...
    def _initialize_postgresql(self):
        ...
        if not POSTGRES_AVAILABLE:
            raise DatabaseError("PostgreSQL dependencies not installed. Run: pip install psycopg2-binary")
        ...
        try:
            with self.get_connection() as conn:
                ...
                return {
                    ...
                    'database_url': self.database_url.split('@')[0] + '@***' if '@' in self.database_url else 'local',
