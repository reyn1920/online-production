...
class SecretStoreBridge:
    ...
    def _find_cli(self) -> Optional[str]:
        ...
        try:
            result = subprocess.run(["which", "secrets_cli"], 
    ...
    def _check_availability(self) -> bool:
        ...
        try:
            result = subprocess.run(["python3", self.cli_path, "--version"], 
    ...
    def list_secrets(self) -> Dict[str, Any]:
        ...
        env_secrets = [key for key in os.environ.keys() 
    ...
    def get_api_credentials(self) -> Dict[str, Optional[str]]:
        ...
        credentials = {
            ...
            "speechelo_email": self.get_secret("SPEECHELO_EMAIL", "Brianinpty@gmail.com"),
            "speechelo_password": self.get_secret("SPEECHELO_PASSWORD"),
            "davinci_resolve_path": self.get_secret("DAVINCI_RESOLVE_PATH"),
            "blender_path": self.get_secret("BLENDER_PATH", "/Applications/Blender.app/Contents/MacOS/Blender")
        }
