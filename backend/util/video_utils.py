...
class VideoProcessor:
    ...
    def create_video(self, script_data: Dict[str, Any], filename: str = "video.mp4") -> Dict[str, Any]:
        """Create a video from script data"""
        output_path = self.output_dir / filename
        return create_video_from_script(script_data, str(output_path))
    
    def generate_thumbnail(self, video_path: str, timestamp: str = "00:00:01") -> Dict[str, Any]:
        """Generate thumbnail from video"""
        return generate_video_thumbnail(video_path, timestamp)

def create_video_from_script(script_data: Dict[str, Any], output_path: str) -> Dict[str, Any]:
    """
...
def generate_video_thumbnail(video_path: str, timestamp: str = "00:00:01") -> Dict[str, Any]:
    """
