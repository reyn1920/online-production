...
class OllamaIntegration:
    ...
    def _setup_performance_monitoring(self):
        ...
        try:
            ...
            self.metrics_collection_interval = self.config.get(
    ...
    def _collect_system_metrics(self):
        ...
        try:
            ...
            cache_hits = sum(
                1 for r in self.request_history if hasattr(r, "cached") and r.cached
            )
            cache_hit_rate = (
        ...
        logger.info(
            f"OllamaIntegration initialized with endpoint: {self.ollama_endpoint}"
        )
        ...
        try:
            ...
            if context:
                if "code" in context or "programming" in str(context).lower():
                    ...
                    or "analysis" in str(context).lower()
                ):
                    return ModelType.STRATEGIC_ANALYSIS.value
