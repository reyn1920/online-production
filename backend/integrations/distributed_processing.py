...
class DistributedProcessingSystem:
    ...
    def __init__(self, broker_url: str = None, result_backend: str = None):
        ...
        self.result_backend = result_backend or self.config.get('result_backend', 'redis://localhost:6379/0')
    ...
    def register_worker(self, capabilities: WorkerCapabilities) -> bool:
        ...
        try:
            ...
            logger.info(f"Registered worker {capabilities.worker_id} "
    ...
    def get_system_status(self) -> Dict[str, Any]:
        ...
        active_workers = len([w for w in self.workers.values() 
                            ...
                            datetime.now() - w.last_heartbeat < timedelta(minutes=2)])
