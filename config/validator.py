...
class ConfigValidator:
    ...
    def _validate_api_key(self, value: str) -> Tuple[bool, str]:
        ...
        placeholder_patterns = [
            'your-api-key', 'api-key-here', 'change-me', 
    ...
    def _validate_boolean(self, value: str) -> Tuple[bool, str]:
        ...
        return False, "Boolean value must be true/false, 1/0, yes/no, on/off, or enabled/disabled"
            ...
            if value is None or value.strip() == '':
                ...
                if validator:
                    ...
                    if is_valid:
                        ...
                        level = ValidationLevel.ERROR if rules['required'] else ValidationLevel.WARNING
                        result = ValidationResult(
                            key=key,
                            level=level,
