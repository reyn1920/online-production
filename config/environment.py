...
class EnvironmentConfig:
    ...
    def __init__(self):
        ...
        logger.info(f"Pet care APIs status: eBird={self.pet_care_apis.is_ebird_enabled}, "
        ...
        logger.info(f"Geocoding APIs status: Nominatim={self.geocoding_apis.is_nominatim_enabled}, "
    ...
    def _load_feature_flags(self) -> FeatureFlags:
        ...
        return FeatureFlags(
            affiliate_processing=self._get_bool_env('ENABLE_AFFILIATE_PROCESSING', True),
