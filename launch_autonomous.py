...
from backend.core.task_queue import TaskQueue, TaskPriority
...
class AutonomousSystemLauncher:
    ...
    def start_health_monitoring(self):
        ...
        self.health_monitor_thread = threading.Thread(
            target=self.health_monitor_loop,
            daemon=True
        )
    ...
    def perform_health_check(self):
        ...
        try:
            ...
            if self.task_queue:
                ...
                if metrics.total_tasks == 0 and (datetime.now() - self.last_health_check).seconds > 3600:
        ...
        try:
            ...
            for worker_id, status in agent_status.items():
                ...
                if time_since_heartbeat > 300:  # 5 minutes
                    self.logger.warning(f"Agent {worker_id} hasn't sent heartbeat in {time_since_heartbeat}s")
    ...
    def check_task_queue_health(self):
        ...
        try:
            ...
            if metrics.total_tasks > 0:
                failure_rate = (metrics.failed_tasks + metrics.dead_letter_tasks) / metrics.total_tasks
            ...
            # Log queue metrics
            self.logger.debug(f"Queue metrics: {metrics.pending_tasks} pending, "
        ...
        try:
            ...
            if self.task_queue:
                ...
                if metrics.total_tasks > 100 and metrics.success_rate < 90:
                    self.logger.warning(f"System performance degraded: {metrics.success_rate:.1f}% success rate")
