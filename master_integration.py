...
try:
    ...
    from backend.specialized_agents import SystemAgent, ResearchAgent, ContentAgent
...
class MasterIntegration:
    ...
    def _ensure_directories(self):
        ...
        directories = [
            "data", "logs", "outputs", "outputs/audio", "outputs/videos", "outputs/pdfs",
            "content", "content/templates", "content/scripts", "content/images",
            "static", "app/templates", "monitoring"
        ]
    ...
    async def create_content_pipeline_task(self, content_type: str, parameters: Dict[str, Any]) -> str:
...
def get_master_integration(config: Optional[IntegrationConfig] = None) -> MasterIntegration:
