...
class TestChannelAPI:
    ...
    async def test_create_channel_failure(
        self, mock_create_channel, mock_session, mock_user, channel_create_data
    ):
    ...
    async def test_get_channels_success(
        self, mock_get_channels, mock_session, mock_user, mock_channel
    ):
    ...
    async def test_get_channel_by_id_success(
        self, mock_get_channel, mock_session, mock_user, mock_channel
    ):
    ...
    @pytest.mark.asyncio
    async def test_get_channel_by_youtube_id_success(
        self, mock_get_channel, mock_session, mock_user, mock_channel
    ):
    ...
    @patch("src.backend.api.channels.ChannelService.get_channel_by_youtube_id")
    @pytest.mark.asyncio
    async def test_get_channel_by_youtube_id_not_found(
        self, mock_get_channel, mock_session, mock_user
    ):
    ...
    async def test_update_channel_not_found(
        self, mock_get_channel, mock_session, mock_user, channel_update_data
    ):
    ...
    @pytest.mark.asyncio
    async def test_update_channel_stats_success(
        self, mock_update_stats, mock_get_channel, mock_session, mock_user, mock_channel
    ):
