...
class TraeAILauncher:
    ...
    def check_dependencies(self) -> bool:
        ...
        required_packages = [
            ...
            'openai', 'anthropic', 'flask', 'flask_socketio'
        ]
    ...
    def setup_directories(self):
        ...
        directories = [
            'logs', 'temp', 'output', 'data', 'uploads',
            'static/videos', 'static/images', 'static/audio'
        ]
    ...
    def print_service_status(self):
        ...
        for name, port, description in services_info:
            status = "🟢 RUNNING" if name in self.processes or name == "Main Dashboard" else "🔴 STOPPED"
