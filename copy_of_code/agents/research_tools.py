...
class BreakingNewsWatcher:
    ...
    def _get_default_feeds(self) -> List[Dict[str, str]]:
        ...
        return [
            {'url': 'https://feeds.feedburner.com/TechCrunch', 'category': NewsCategory.TECHNOLOGY},
            {'url': 'https://rss.cnn.com/rss/edition.rss', 'category': NewsCategory.GENERAL},
            {'url': 'https://feeds.reuters.com/reuters/businessNews', 'category': NewsCategory.BUSINESS},
            {'url': 'https://feeds.feedburner.com/venturebeat/SZYF', 'category': NewsCategory.TECHNOLOGY},
            {'url': 'https://feeds.feedburner.com/Mashable', 'category': NewsCategory.TECHNOLOGY},
            {'url': 'https://feeds.feedburner.com/socialmediaexaminer', 'category': NewsCategory.SOCIAL_MEDIA},
            {'url': 'https://feeds.feedburner.com/MarketingLand', 'category': NewsCategory.MARKETING},
        ]
