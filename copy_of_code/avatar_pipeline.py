...
class MixamoInterface:
    ...
    def animate_character(self, rigged_model_path: str, animation_spec: AnimationSpec,
                         output_path: str) -> str:
    ...
    def _create_basic_animation(self, model_path: str, spec: AnimationSpec, output_path: str) -> str:
...
class BlenderCompositor:
    ...
    def composite_avatar(self, animated_model_path: str, spec: CharacterSpec,
                        output_path: str, render_settings: Optional[Dict] = None) -> str:
    ...
    def _generate_blender_script(self, model_path: str, spec: CharacterSpec,
                                output_path: str, render_settings: Dict) -> str:
...
class AvatarPipeline:
    ...
    def rig_and_animate_model(self, base_model_path: str, spec: CharacterSpec,
                             animation_spec: Optional[AnimationSpec] = None) -> Tuple[str, str]:
        ...
        if animation_spec:
            ...
            animated_model = self.mixamo.animate_character(rigged_model, animation_spec, animated_path)
            return rigged_model, animated_model
        else:
            return rigged_model, rigged_model
    
    def composite_avatar_in_blender(self, animated_model_path: str, spec: CharacterSpec,
                                   render_settings: Optional[Dict] = None) -> str:
        """Composite avatar in Blender for final rendering.
        ...
        return self.blender.composite_avatar(animated_model_path, spec, output_path, render_settings)
    
    def create_full_avatar(self, spec: CharacterSpec, animation_spec: Optional[AnimationSpec] = None,
                          render_settings: Optional[Dict] = None) -> AvatarResult:
    ...
    def batch_create_avatars(self, specs: List[CharacterSpec],
                           animation_specs: Optional[List[AnimationSpec]] = None,
                           render_settings: Optional[Dict] = None) -> List[AvatarResult]:
