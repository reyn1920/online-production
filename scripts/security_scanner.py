...
class SecurityScanner:
        ...
        for secret_type, config in self.secret_patterns.items():
            ...
            for match in matches:
                ...
                secret_value = match.group(
                    2) if match.lastindex >= 2 else match.group(0)
    ...
    def _is_placeholder(self, value: str) -> bool:
        ...
        placeholder_indicators = [
            'your_', 'example', 'placeholder', 'test_', 'demo_',
            'fake_', 'sample_', 'xxx', 'yyy', 'zzz', '123',
                    ...
                    for vuln_name, vuln_data in vulnerabilities.items():
                        ...
                        self.issues.append(
                            SecurityIssue(
                                ...
                                cve_id=vuln_data.get(
                                    'cve',
                                    [None])[0] if vuln_data.get('cve') else None,
                                confidence=1.0))
                ...
                try:
                    ...
                    for pattern in endpoint_patterns:
                        ...
                        for match in matches:
                            ...
                            if any(sensitive in endpoint.lower() for sensitive in
    ...
    def _is_source_file(self, file_path: Path) -> bool:
        ...
        source_extensions = {
            '.py', '.js', '.ts', '.jsx', '.tsx', '.php', '.java', '.c', '.cpp',
