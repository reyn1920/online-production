...
class PaddleAPI(BaseMonetizationAPI):
    ...
    def __init__(self, api_key: str, vendor_id: str, environment: str = 'sandbox'):
        base_url = (
            "https://vendors.paddle.com/api/2.0" if environment == 'production'
    ...
    def create_product(self, product: Product) -> ProductResponse:
        ...
        try:
            product_data = {
                ...
                'recurring_price': product.price if product.metadata.get('subscription') else None,
    ...
    def get_sales_data(self, start_date: datetime, end_date: datetime) -> Dict[str, Any]:
        ...
        try:
            ...
            if response_data.get('success'):
                ...
                total_revenue = sum(
                    float(transaction.get('earnings', 0)) 
    ...
    def create_checkout_url(self, product_id: str, custom_data: Dict[str, Any] = None) -> Optional[str]:
