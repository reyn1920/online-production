...
class Config:
    ...
    MONETIZATION_BUNDLE_URL = os.getenv("MONETIZATION_BUNDLE_URL", "http://monetization_bundle:8003")
...
task_duration = Histogram('orchestrator_task_duration_seconds', 'Task processing duration', ['agent'])
...
class TraeAIOrchestrator:
    ...
    async def call_agent(self, agent: str, task_type: str, payload: Dict[str, Any]) -> Dict[str, Any]:
