...
class RegexNoiseFilter(logging.Filter):
    ...
    def __init__(self, 
        ...
        self.compiled_drop_patterns = [re.compile(pattern, re.IGNORECASE) 
                                     for pattern in self.drop_patterns]
        self.compiled_reduce_patterns = [re.compile(pattern, re.IGNORECASE) 
                                       for pattern in self.reduce_patterns]
...
class TraeLogger:
    ...
    def configure_noise_filter(self, 
                              drop_patterns: List[str] = None, 
                              reduce_patterns: List[str] = None,
                              reduce_frequency: int = None) -> None:
        """
