...
class YouTubeAPI(BaseAPI):
    ...
    async def search_videos(
        ...
        try:
            ...
            detailed_videos = await self.get_video_details(video_ids) if video_ids else []
            
            return {
                'query': query,
                'total_results': response_data.get('pageInfo', {}).get('totalResults', 0),
            ...
            for keyword in keywords:
                try:
                    ...
                    for video in videos:
                        ...
                        engagement = int(video.get('view_count', 0)) + int(video.get('like_count', 0)) * 10
    ...
    async def find_viral_content(
        ...
        try:
            ...
            for video in trending_videos:
                ...
                days_old = (datetime.utcnow().replace(tzinfo=published_date.tzinfo) - published_date).days
    ...
    async def _make_youtube_request(self, endpoint: str, params: Dict[str, Any]) -> Dict[str, Any]:
