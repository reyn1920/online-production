            ...
            for keyword in keywords:
                ...
                if keyword_data['total_papers'] > 0:
                    keyword_data['trend_score'] = (
                        keyword_data['recent_papers'] / 
                        max(keyword_data['total_papers'], 1)
                    ) * 100
                else:
        ...
        try:
            ...
            for paper in all_papers:
                ...
                for word in words:
                    if (len(word) > 4 and 
                        word.isalpha() and 
                        word not in ['paper', 'study', 'research', 'analysis', 'method', 'approach']):
            ...
            for keyword, count in keyword_counts.items():
                if count >= min_papers:
                    ...
                    emerging_topics.append({
                        ...
                        'categories': list(set(paper['category'] for paper in keyword_papers[keyword]))
                    })
