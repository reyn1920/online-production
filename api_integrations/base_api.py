...
class RateLimiter:
    ...
    async def acquire(self) -> bool:
        ...
        raise RateLimitError(f"Rate limit exceeded, wait {wait_time:.2f} seconds", retry_after=int(wait_time))
                ...
                async with self.session.request(
                    ...
                    if response.status == 429:
                        ...
                        if attempt < max_retries:
                            ...
                            raise RateLimitError("Server rate limit exceeded", retry_after)
