    ...
    def create_audio_video(self, title: str, duration: int = 10) -> str:
        ...
        try:
            ...
            cmd = [
                "ffmpeg", "-y",
                "-f", "lavfi",
                "-i", f"color=c=green:size=1280x720:duration={duration}",
                "-f", "lavfi",
    ...
    def create_demo_video(self) -> str:
        ...
        try:
            ...
            cmd = [
                "ffmpeg", "-y",
                "-f", "lavfi",
                "-i", "color=c=red:size=1280x720:duration=15",
                "-f", "lavfi",
                "-i", "sine=frequency=523:duration=15",
                "-vf", "drawtext=text='TRAE.AI Production System':fontcolor=white:fontsize=42:x=(w-text_w)/2:y=(h-text_h)/2",
                "-c:v", "libx264",
                "-c:a", "aac",
                "-pix_fmt", "yuv420p",
                "-t", "15",
