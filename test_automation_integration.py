...
from content_automation_pipeline import ContentAutomationPipeline, ContentPriority, ContentFormat, ContentOpportunity
...
class TestRSSIntelligenceEngine(unittest.TestCase):
    ...
    def test_database_initialization(self):
        ...
        required_tables = [
            'news_articles', 'trend_analysis', 'hypocrisy_tracker', 'intelligence_briefings'
        ]
    ...
    def test_article_storage_and_retrieval(self):
        ...
        conn = sqlite3.connect(self.test_db)
        cursor = conn.cursor()
        cursor.execute("SELECT * FROM news_articles WHERE hash_id = ?", ("test_hash_123",))
...
class TestContentAutomationPipeline(unittest.TestCase):
    ...
    def test_content_opportunity_creation(self):
        ...
        cursor = conn.cursor()
        cursor.execute("SELECT * FROM content_opportunities WHERE id = ?", ("test_opp_123",))
        result = cursor.fetchone()
    ...
    def test_pipeline_status(self):
        ...
        self.assertIn('pending_opportunities', status, "Status should include pending opportunities")
...
class TestAutomationController(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.controller.performance_db = os.path.join(self.temp_dir, 'test_performance.db')
    ...
    def test_controller_initialization(self):
        ...
        self.assertIsNotNone(self.controller.content_pipeline, "Content pipeline not initialized")
        self.assertIsNotNone(self.controller.rss_engine, "RSS engine not initialized")
        self.assertFalse(self.controller.running, "Controller should not be running initially")
    ...
    def test_automation_status(self):
        ...
        self.assertFalse(status.content_pipeline_running, "Pipeline should not be running")
...
class TestEndToEndIntegration(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.pipeline.db_path = os.path.join(self.temp_dir, 'test_integration_content.db')
        self.pipeline._init_automation_tables()
    ...
    def test_complete_content_workflow(self):
        ...
        if opportunities:
            ...
            self.assertGreater(len(projects), 0, "No projects generated from opportunity")
            ...
            if video_projects:
                ...
                self.assertEqual(video_project.status, 'completed', "Video project not completed")
    ...
    def _verify_database_integrity(self):
        ...
        self.assertEqual(orphaned_projects, 0, "Found orphaned projects without opportunities")
...
def run_performance_benchmark():
    ...
    try:
        ...
        print(f"   - Identified {len(opportunities)} opportunities in {opportunity_time:.3f} seconds")
        ...
        if opportunities:
            ...
            print(f"   - Generated {len(projects)} projects in {generation_time:.3f} seconds")
...
if __name__ == "__main__":
    ...
    parser = argparse.ArgumentParser(description='TRAE.AI Content Automation Integration Tests')
