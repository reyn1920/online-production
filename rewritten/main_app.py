...
#         }
    ...
    async def process_with_ai_enhancement(
        self, task: str, content: str, task_type: str = "general"
    ) -> Dict[str, Any]:
...
#     ) -> AIResponse:
    ...
    async def analyze_with_all_ai(
        ...
        newline_content = f"Please perform a {analysis_type} analysis of the following content:\n\n{content}"
        analysis_prompt = newline_content
...
#             )
            ...
            if result.success:
                self.logger.info("Avatar generation successful")
            else:
