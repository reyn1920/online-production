...
#                 }
    ...
    async def _convert_audio_format(
        self, source_path: str, target_path: str, target_format: str
    ) -> Dict[str, Any]:
...
#             )
    ...
    async def generate_script_voices(
        self, script: List[Dict[str, str]], output_format: str = "wav"
    ) -> Dict[str, Any]:
...
#                     )
                ...
                failed_tracks.append({"track_name": track_name, "error": str(e)})
...
#     )
    ...
    print("\\n💡 Usage Instructions:")
    print("1. Import the generated audio files into DaVinci Resolve")
    print("2. Use the XML timeline file to automatically arrange tracks")
    print("3. Sync with your video content and adjust timing as needed")
    print("4. Export your final video with professional voice narration")
