...
def test_dashboard_endpoints():
    ...
    for test in test_cases:
        try:
            ...
            if response.status_code == test["expected_status"]:
                ...
                if test.get("check_content"):
                    if test["check_content"] in response.text:
                        ...
                        print("  Status: ⚠️  PARTIAL - Status OK but content check failed")
                    ...
                    try:
                        ...
                        print("  Status: ⚠️  PARTIAL - Status OK but invalid JSON")
                else:
            ...
            print("  Status: ❌ FAIL - Request timeout")
            failed += 1
    ...
    try:
        ...
        services_response = requests.get(f"{base_url}/dashboard/api/services", timeout=5)
