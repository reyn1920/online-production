...
class MacBookAirM1Benchmark:
    ...
    def print_performance_analysis(self, results: List[Dict[str, Any]]):
        ...
        print("  • Target: 2k - 5k req/sec for simple endpoints")
        print("  • Target: <50ms p95 latency up to 200 concurrent clients")
        print("  • Memory: Keep under 2GB total")
        print("  • Nginx: 2 workers, 1024 connections each")
        print("  • FastAPI: 2 - 4 Uvicorn workers recommended")
