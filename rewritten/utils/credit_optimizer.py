...
#         }
    ...
    def get_optimization_analytics(self) -> Dict:
        ...
        analytics = {
            ...
            "total_requests_tracked": sum(1 for pattern in self.usage_patterns.values()),
            "model_performance": {},
            "cost_insights": {},
            "recommendations": [],
# BRACKET_SURGEON: disabled
...
#             }
        ...
        if self.usage_patterns:
            ...
            most_efficient = max(self.usage_patterns.items(), key=lambda x: x[1].cost_efficiency)

            least_efficient = min(self.usage_patterns.items(), key=lambda x: x[1].cost_efficiency)
