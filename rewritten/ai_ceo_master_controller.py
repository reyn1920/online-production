...
class AICEOMasterController:
    ...
    async def _check_system_health(self) -> Dict[str, Any]:
        ...
        try:
            ...
            try:
                ...
                health_status["system_checks"]["database"] = "healthy"
            except Exception as e:
            ...
            if hasattr(self, "automation_controller") and self.automation_controller:
                try:
                    health_status["system_checks"]["automation"] = "healthy"
                except Exception as e:
                    health_status["issues"].append(
                        {
            ...
            for agent_name in agent_systems:
                if hasattr(self, agent_name):
                    try:
                        ...
                        if agent and hasattr(agent, "is_healthy"):
                            if agent.is_healthy():
            ...
            if self.business_metrics.last_updated:
                time_since_update = (
                    current_time - self.business_metrics.last_updated
                ).total_seconds()
            ...
            if self.business_metrics.api_costs > self.business_metrics.daily_revenue * 0.3:
                health_status["issues"].append(
                    {
    ...
    async def _scan_for_opportunities(self) -> List[Dict[str, Any]]:
        ...
        try:
            ...
            if current_metrics.conversion_rate > 0 and current_metrics.conversion_rate < 0.1:
                opportunities.append(
                    {
                        "type": "conversion_optimization",
                        "priority": "high",
                        "title": "Conversion Rate Optimization",
                        "description": f"Current conversion rate is {current_metrics.conversion_rate:.3f}. Industry average is 2-5%.",
                        "potential_impact": "20-50% revenue increase",
                ...
                opportunities.append(
                    {
                        ...
                        "description": f"API costs are {(current_metrics.api_costs/current_metrics.daily_revenue)*100:.1f}% of daily revenue.",
                        "potential_impact": "10-30% cost savings",
                ...
                opportunities.append(
                    {
                        ...
                        "description": f"Current growth rate is {current_metrics.growth_rate:.1%}. Potential for acceleration.",
                        "potential_impact": "25-100% growth increase",
                    ...
                    opportunities.append(
                        {
                            ...
                            "description": f"LTV:CAC ratio is {ltv_cac_ratio:.1f}. Target is 3:1 or higher.",
                            "potential_impact": "15-40% profitability increase",
                            "estimated_effort": "medium",
                            "actions": [
                ...
                opportunities.append(
                    {
                        ...
                        "description": "High operational costs indicate potential for automation.",
                        "potential_impact": "20-50% operational cost reduction",
                        "estimated_effort": "high",
                        "actions": [
                ...
                opportunities.append(
                    {
                        ...
                        "priority": "low",
                        "title": "Peak Hours Marketing Push",
                        "description": "Currently in peak business hours - optimal time for marketing activities.",
                        "potential_impact": "5-15% engagement increase",
                        "estimated_effort": "low",
                        "actions": [
