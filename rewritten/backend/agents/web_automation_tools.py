...
#             ) ** 0.5
    ...
    async def stealth_type(self, text: str, interval: Optional[float] = None) -> None:
        ...
        for i, char in enumerate(text):
            ...
            if self.profile.human_errors and random.random() < 0.02 and char.isalpha():  # 2% chance
...
#             }
        ...
        try:
            actions = [
                AutomationAction(action_type=ActionType.WAIT, target="startup_delay", value="2.0"),
                AutomationAction(
