...
#         ].strip()  # strip need as there is space at end!
        ...
        # Filtering for microphone input, as it has BG noise, maybe silence in beginning \
    # and end
...
#                     )
        ...
        # note diffusion_conditioning not used on hifigan (default mode),
    it will be empty but need to pass it to model.inference
        try:
            (
                gpt_cond_latent,
                    speaker_embedding,
