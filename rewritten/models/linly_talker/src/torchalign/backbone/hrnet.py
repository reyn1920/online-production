...
class HighResolutionNet(nn.Module):
    def __init__(
        ...
        num_channels = [num_channels[i] * self.block[1].expansion for i in range(len(num_channels))]
        ...
        num_channels = [num_channels[i] * self.block[2].expansion for i in range(len(num_channels))]
        ...
        num_channels = [num_channels[i] * self.block[3].expansion for i in range(len(num_channels))]
    ...
    def _make_stage(self, stage_index, in_channels, multi_scale_output=True):
