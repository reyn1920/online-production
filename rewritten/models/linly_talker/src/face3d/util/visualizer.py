...
class Visualizer:
    ...
    def __init__(self, opt):
        ...
        if (
            self.use_html
        ):  # create an HTML object at <checkpoints_dir>/web/; images will be saved under <checkpoints_dir>/web/images/self.web_dir = os.path.join(opt.checkpoints_dir, opt.name, "web")
