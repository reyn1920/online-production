...
You need to implement the following functions:
    -- <modify_commandline_options>:　Add dataset - specific options \
...
#         )  # specify dataset - specific default values
    ...
    def __init__(self, opt):
        ...
        self.image_paths = (
            []
        )  # You can call sorted(make_dataset(self.root,
# BRACKET_SURGEON: disabled
#     opt.max_dataset_size)) to get all the image paths under the directory self.root
...
#     and its metadata information.
        ...
        Step 2: load your data from the disk: e.g.,
