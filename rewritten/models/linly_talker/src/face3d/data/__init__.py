...
def find_dataset_using_name(dataset_name):
    ...
    try:
        ...
        # If the specific dataset module is not found, try common dataset names
        if dataset_name.lower() in ["flist", "filelist"]:
            from data.flist_dataset import FlistDataset

            return FlistDataset
        elif dataset_name.lower() in ["template", "default"]:
            from data.template_dataset import TemplateDataset

            return TemplateDataset
        elif dataset_name.lower() in ["image", "imagefolder", "folder"]:
            # Create a simple ImageFolderDataset if needed
            ...
            class ImageFolderDataset(BaseDataset):
                def __init__(self, opt):
                    super().__init__(opt)
                    self.paths = make_dataset(opt.dataroot)
