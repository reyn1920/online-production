...
def get_scheduler(optimizer, opt):
    ...
    if opt.lr_policy == "linear":
        ...
        scheduler = lr_scheduler.ExponentialLR(optimizer, gamma=getattr(opt, "lr_gamma", 0.95))
    elif opt.lr_policy == "multistep":
        milestones = getattr(opt, "lr_milestones", [30, 60, 90])
        scheduler = lr_scheduler.MultiStepLR(optimizer, milestones=milestones, gamma=0.1)
    elif opt.lr_policy == "none" or opt.lr_policy == "constant":
...
func_dict = {
    ...
    "wide_resnet50_2": (wide_resnet50_2, 2048),
    "wide_resnet101_2": (wide_resnet101_2, 2048),
}
