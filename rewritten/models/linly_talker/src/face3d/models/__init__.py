...
You need to implement the following five functions:
    ...
    -- <optimize_parameters>:           calculate loss, gradients, \
...
In the function <__init__>, you need to define four lists:
    ...
    -- self.visual_names (str list):        specify the images that you want to display \
    and save.
    -- self.optimizers (optimizer list):    define \
    and initialize optimizers. You can define one optimizer for each network. If two networks are updated at the same time, you can use itertools.chain to group them. See cycle_gan_model.py for an usage.
