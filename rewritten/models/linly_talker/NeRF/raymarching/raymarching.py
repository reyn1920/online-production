...
class _march_rays_train(Function):
    ...
    def forward(
        ...
        Args:
            ...
            H: int
            nears/fars: float, [N]
            step_counter: int32, (2),
    used to count the actual number of generated points.
            mean_count: int32,
    estimated mean steps to accelerate training. (but will randomly drop rays if the actual point count exceeded this threshold.)
            perturb: bool
...
class _composite_rays_train_sigma(Function):
    ...
    def backward(ctx, grad_weights_sum, grad_ambient_sum, grad_depth, grad_image):
        ...
        _backend.composite_rays_train_sigma_backward(
            grad_weights_sum,
            grad_ambient_sum,
            grad_image,
            sigmas,
...
class _composite_rays_train_uncertainty(Function):
    ...
    def backward(
        ...
        _backend.composite_rays_train_uncertainty_backward(
            grad_weights_sum,
            grad_ambient_sum,
            grad_uncertainty_sum,
            grad_image,
...
class _composite_rays_train_triplane(Function):
    ...
    def forward(ctx, sigmas, rgbs, amb_aud, amb_eye, uncertainty, deltas, rays, T_thresh=1e-4):
        ...
        _backend.composite_rays_train_triplane_forward(
            sigmas,
            rgbs,
            amb_aud,
            amb_eye,
    ...
    def backward(
        ...
        _backend.composite_rays_train_triplane_backward(
            grad_weights_sum,
            grad_amb_aud_sum,
            grad_amb_eye_sum,
            grad_uncertainty_sum,
