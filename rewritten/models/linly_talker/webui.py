...
def TTS_response(
    ...
    if tts_method == "GPT - SoVITS克隆声音":
        try:
            vits.predict(
                ref_wav_path = question_audio if use_mic_voice else ref_audio,
...
def LLM_response(
    ...
    ref_audio,
        prompt_text,
        prompt_language,
        text_language,  # 提示音频、文本及其语言设置
    cut_method,
        use_mic_voice,
        mode_checkbox_group,
        sft_dropdown,  # 其他TTS选项
    prompt_text_cv,
        prompt_wav_upload,
        prompt_wav_record,  # 提示信息和音频选项
    seed,
