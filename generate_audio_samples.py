...
class AudioSampleGenerator:
            ...
            for voice_key, voice_config in VOICE_CONFIGS.items():
                ...
                try:
                    result = self._generate_sample(
                        text_key, text_info, voice_key, voice_config
                    )
                    ...
                    if result:
                        ...
                        logger.info(
                            f"✅ Generated: {text_key} + {voice_key} "
    ...
    def _generate_sample(self, text_key: str, text_info: Dict, 
                        voice_key: str, voice_config: Dict) -> Dict[str, Any]:
    ...
    def generate_voice_showcase(self):
        ...
        for voice_key in available_voices:
            try:
                ...
                result = self._generate_sample(
                    "showcase", text_info, voice_key, voice_config
                )
...
def main():
    ...
    try:
        ...
        if sample_info['successful_samples'] > 0:
            total_duration = sum(
                sample['duration'] for sample in sample_info['samples'] 
