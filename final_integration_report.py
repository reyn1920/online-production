...
def main():
    ...
    print(
        f"  💼 Affiliate Integrations: {'✅ ACTIVE' if affiliates_ok else '❌ ISSUES'}"
    )
    print(
        f"  📺 Channel Integrations: {'✅ COMPLETE' if channels_ok else '❌ INCOMPLETE'}"
    )
    print(
        f"  📊 Dashboard Integrations: {'✅ OPERATIONAL' if dashboard_ok else '❌ ISSUES'}"
    )
